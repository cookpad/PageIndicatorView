...
public abstract class BaseColorAnimation<T extends ColorAnimationValue>
        extends BaseAnimation<ValueAnimator, T> {
    ...
    public BaseColorAnimation(@Nullable ValueController.UpdateListener listener) {
        super(listener);
    }
    ...
    @NonNull
    public BaseColorAnimation with(int colorStart, int colorEnd) {
    ...
    private void onAnimateUpdated(@NonNull ValueAnimator animation) {
        ...
        ColorAnimationValue value = getValue();
