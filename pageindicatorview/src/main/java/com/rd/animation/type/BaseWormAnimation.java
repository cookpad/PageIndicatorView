...
public abstract class BaseWormAnimation<T extends WormAnimationValue>
        extends BaseAnimation<AnimatorSet, T> {
    ...
    public BaseWormAnimation(@NonNull ValueController.UpdateListener listener) {
        super(listener);
    }
    ...
    public BaseWormAnimation with(int coordinateStart, int coordinateEnd, int radius, boolean isRightSide) {
        if (hasChanges(coordinateStart, coordinateEnd, radius, isRightSide)) {
            ...
            WormAnimationValue value = getValue();
